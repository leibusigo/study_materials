...
![image-20210727095737846](.\typora_pic\image-20210727095737846.png)

5）原型链：一个对象往往可以通过不断使用对象原型`__proto__`追溯到最根源的原型对象上，这个原型对象就是null，这种通过原型对象和对象原型一层层向上查找的关系就被称为原型链。

![image-20210727100254178](.\typora_pic\image-20210727100254178.png)
...
![image-20210731202840221.png](.\typora_pic\image-20210731202840221.png)
...
![image-20210801084310173](.\typora_pic\image-20210801084310173.png)

* 对象的解构：

![image-20210801084324448](.\typora_pic\image-20210801084324448.png)
...
![image-20210803201353731](.\typora_pic\image-20210803201353731.png)
...
![image-20210803161843815](.\typora_pic\image-20210803161843815.png)
